...
<section class="bg-[#183D3D] text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-['Playfair_Display'] font-semibold mb-4 text-center">Completed Works</h1>
    </div>
</section>
    ...
    <div class="w-full max-w-[95vw] md:max-w-[90vw] lg:max-w-[1400px] mx-auto px-2 md:px-4">
        ...
        <?php if (empty($completed_projects)): ?>
            ...
            <div class="text-center py-20">
                <p class="text-[#D3DAD9] text-lg">No completed projects yet. Check back soon!</p>
            </div>
        <?php else: ?>
            <!-- Projects Grid -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <?php foreach ($completed_projects as $project): ?>
                    <a href="project_details.php?id=<?php echo urlencode($project['project_id']); ?>&type=completed" class="group cursor-pointer">
