...
$projects_dir = '../assets/projects/completed/';
$completed_projects = [];
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <?php if (empty($completed_projects)): ?>
        <div class="text-center py-20">
            ...
            <a href="upload_completed.php" class="inline-block bg-[#5C8374] text-[#183D3D] px-6 py-3 rounded font-semibold hover:bg-[#44444E] hover:text-[#FFFFFF] transition">
                ...
                <div class="bg-[#183D3D] rounded-lg shadow-lg overflow-hidden border border-[#44444E] hover:border-[#5C8374] transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex gap-2">
                            <a href="view_project.php?id=<?php echo urlencode($project['project_id']); ?>&type=completed" class="flex-1 bg-[#5C8374] text-[#183D3D] px-3 py-2 rounded text-sm font-medium hover:bg-[#44444E] hover:text-[#FFFFFF] transition text-center">
                                View
                            </a>
                            <a href="edit_project.php?id=<?php echo urlencode($project['project_id']); ?>&type=completed" class="flex-1 bg-[#44444E] text-[#FFFFFF] px-3 py-2 rounded text-sm font-medium hover:bg-[#5C8374] hover:text-[#183D3D] transition text-center">
                                Edit
                            </a>
