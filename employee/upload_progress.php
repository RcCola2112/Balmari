...
$page_title = "Upload Project In Progress";
...
<section class="bg-[#183D3D] text-[#D3DAD9] py-16">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-['Playfair_Display'] font-semibold mb-4 text-center">Upload Project In Progress</h1>
    </div>
</section>
...
<div class="min-h-screen bg-[#040D12] max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-[#D3DAD9]">
    ...
    <div class="bg-[#183D3D] rounded-2xl shadow-xl p-8 border border-[#5C8374] text-[#D3DAD9]">
        <form action="upload_progress_process.php" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Additional Images -->
            <div>
                <label for="detail_images" class="block font-semibold mb-2 text-[#5C8374]">Additional Progress Images</label>
                <input 
                    type="file" 
                    id="detail_images" 
                    name="detail_images[]" 
                    ...
                    class="w-full text-[#D3DAD9]"
                >
                <p class="text-[#5C8374]/70 text-sm mt-2">Upload additional detail images showing project progress stages (Each max 5MB)</p>
            </div>
    ...
    <div class="mt-8 p-4 bg-[#183D3D] border border-[#5C8374] rounded">
        <p class="text-[#5C8374]/80 text-sm">
            <strong>Note:</strong> Images should be clear, well-lit photos of the project in progress. Maximum file size is 5MB.
        </p>
    </div>
</div>
