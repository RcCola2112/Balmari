...
<section class="bg-[#183D3D] text-white py-16">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-['Playfair_Display'] font-semibold mb-4 text-center">Edit Project</h1>
    </div>
</section>
<hr class="border-t border-[#44444E]/30 my-0">
<div class="min-h-screen bg-[#040D12] max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-white">
    <?php if ($project): ?>
        <!-- Header -->
        <div class="mb-8">
                    ...
                    <?php else: ?>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <?php foreach ($detail_images as $img): ?>
                                <div class="bg-[#040D12] rounded p-2 border border-[#44444E]">
                                    <img 
